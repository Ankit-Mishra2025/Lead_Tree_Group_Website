...
export const homeLoanSchema = z.object({
  PropertyAvailablity: z.string().min(1, "Property type is required"),
  propertyPurpose: z.string().min(1, "Property usage is required"),
...
lastName: z
  ...
  loanAmount: z.number().min(500000, "Min loan 5 Lakh"),
  creditScore: z.string().min(1, "Credit score is required"),
  previousLoan: z.string().min(1, "This field is required"),
});

export type HomeLoanSchemaType = z.infer<typeof homeLoanSchema>;
