...
const AutoInsuranceBanner = () => {
 ...
 <p className="text-[17px] font-bold text-gray-800 flex items-center flex-row gap-2 mt-3 w-full"> <ArrowBigRight className="text-green-600"/> Stop Overpaying</p>
            ...
            <button
              ...
              className="mt-10 ml-2 px-8 py-3  bg-green-600 text-white text-[17px] rounded-md font-bold cursor-pointer hover:bg-green-700 hover:translate-x-1 transition-all duration-300"
            >
              Compare Rates
            </button>
          </div>
