        ...
        <div className="flex justify-between items-center w-full ">
          <div className="w-xl">
            ...
            <div className="flex items-center gap-5">
              <button
                className="mt-4 ml-2 w-50 px-8 py-3 bg-green-600 text-white text-[18px] rounded-md font-bold cursor-pointer hover:bg-green-700 hover:translate-x-1 transition-all duration-300"
